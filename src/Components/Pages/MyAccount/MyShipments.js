							...
							<div className="col-12">
								<div className="orderListRow">
									...
									<div className="orderInfo">
										...
										<div className="price__"><i className="fa-solid fa-dollar-sign"></i> 15,000</div>
										...
										<div className="">
											...
											<button type="button" className="gry_btn ml-2">Need Help?</button>
										</div>
									</div>
								</div>
							</div>
							...
							<div className="col-12">
								<div className="orderListRow">
									...
									<div className="orderInfo">
										...
										<div className="price__"><i className="fa-solid fa-dollar-sign"></i> $16,250</div>
										<ul className="orderStep">
											<li className="active">
												<div className="orderTitle">Ordered</div>
												<div className="orderDate">Oct 28th Mon, 2022</div>
