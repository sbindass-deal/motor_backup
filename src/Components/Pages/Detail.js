            ...
            <div className="container">
                <div className="row">
                    <div className="col-12 text-center pb_30">
                        <h2 className="title_combo title_Center">No Reserve: 2019 McLaren Senna</h2>
                    </div>
                        ...
                        <div className="detailPostOption">
                            <div className="">
                                <ul className="labelList">
                                    ...
                                    <li><a href="#"><i className="fa-solid fa-comment"></i> 55 Comments</a></li>
                                </ul>
                            </div>
                            <div className="d-flex">
                                <a href="#" className="gry_btn mr-2">How it Works</a>
                                <a href="#" className="gry_btn mr-2"><i className="fa-solid fa-star mr-2"></i> Watch</a>
                                <button type="button" className="gry_btn active" onclick="smoothScroll(document.getElementById('placeBid_col'))">Place Bid</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="row pt-4">
                    <div className="col-12 pb-3">
                        <div className="postHero">
                            <img src={mclaren_senna_reshoot} />
                        </div>
                    </div>
                    <div className="col-12 dropdownCol">
                        <div className="dropdown mr-2">
                            <button type="button" className="gry_btn dropdown-toggle" data-toggle="dropdown">
                                Make: McLaren
                            </button>
                            <div className="dropdown-menu">
                                <a className="dropdown-item" href="#">View all listings</a>
                                <a className="dropdown-item" href="#">Notify me about new listings</a>
                            </div>
                        </div>
                        <div className="dropdown mr-2">
                            <button type="button" className="gry_btn dropdown-toggle" data-toggle="dropdown">
                                Model: McLaren Ultimate Series
                            </button>
                            <div className="dropdown-menu">
                                <a className="dropdown-item" href="#">View all listings</a>
                                <a className="dropdown-item" href="#">Notify me about new listings</a>
                    ...
                    <div className="col-12 col-lg-9 pt-4">
                        ...
                        <div className="row row_gap_5 videoGalleryRow">
                            ...
                            <div className="col-12 col-sm-6 pt-4">
                                ...
                                <a href="photo-gallery.html" className="gry_btn mt-3">More Photos</a>
                            </div>
                        </div>
                        ...
                        <div className="card_Gray">
                            ...
                            <ul className="bidList_">
                                <li>
                                    ...
                                    <div>USD $1,000,001 by <a href="#">DaveBrewer</a></div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <label>Ends On</label>
                                    <div>Friday, September 23 at 10:30pm <a href="#">remind me</a></div>
                                </li>
                                <li>
                                    <label>Bids</label>
                                    <div>28</div>
                                ...
                                <li>
                                    ...
                                    <div><a href="javascript:void(0)" className="gry_btn" data-toggle="modal" data-target="#RegisterModal">REGISTER TO BID</a></div>
                                </li>
                            </ul>
                            <div className="bid_bottom">
                                <div className="">
                                    <a href="#" className="mr-2">How bidding works</a>
                                    <a href="#"><i className="fa-solid fa-star"></i> Watch auction</a>
                                </div>
                                <div className="">
                    ...
                    <div className="col-12 col-lg-3">
                        <div className="card_Gray mt-4 mb-3">
                            ...
                            <ul className="label__List">
                                <li>
                                    ...
                                    <span className="label__Text"><a href="#">INsennaTY</a></span>
                                </li>
                                <li>
                                    <label className="label__">Location:</label>
                                    <span className="label__Text"><a href="#">Toronto, Ontario, Canada</a></span>
                                </li>
                                <li>
                                    <label className="label__">Listing Details:</label>
                                    <span className="label__Text">
                                        <ul className="listStyle_disc">
                                            <li>Chassis: <a href="#" target="_blank">SBM15ACA1KW800197</a></li>
                                            <li>670 Miles </li>
                        ...
                        <div className="card_Gray mb-3">
                            ...
                            <div className="inlineField">
                                ...
                                <button type="button" className="gry_btn">Sign Up</button>
                            </div>
                        </div>
                        ...
                        <div className="pt-3 pb-3 sidebarPostRow">
                            ...
                            <div className="sidebarPostFooter text-center">
                                <a href="#" className="gry_btn w-full">More features</a>
                            </div>
                        </div>
                        ...
                        <div className="card_Gray mt-3 pt-3">
                            ...
                            <ul className="sidebar_Event">
                                ...
                                <li>
                                    <a href="#">20th Rallylegend 2022 Republic of San Marino, Italy</a>
                                    <div className="event_date"><i className="fa-solid fa-clock"></i> October 13 - 16, 2022</div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div className="event_date"><i className="fa-solid fa-clock"></i> October 14 - 16, 2022</div>
                                </li>
                                <li>
                                    <a href="#">SoCal Vintage BMW</a>
                                    <div className="event_date"><i className="fa-solid fa-clock"></i> November 5, 2022</div>
                                </li>
                            </ul>
                        </div>
                        ...
                        <div className="mt-4 pb-3">
                            <h6>CATEGORIES</h6>
                            <ul className="listStyle_disc">
                                <li><a href="#">Truck & 4×4</a></li>
                                <li><a href="#">Race Cars</a></li>
                                <li><a href="#">Hot Rods</a></li>
                                <li><a href="#">RVs & Campers</a></li>
                                <li><a href="#">Convertibles</a></li>
                                <li><a href="#">Station Wagons</a></li>
                                <li><a href="#">Vans</a></li>
                                <li><a href="#">Motorcycles</a></li>
                                <li><a href="#">Minibikes & Scooters</a></li>
                                <li><a href="#">Projects</a></li>
                                <li><a href="#">Boats</a></li>
                                <li><a href="#">Parts</a></li>
                                <li><a href="#">Wheels</a></li>
                                <li><a href="#">Charity Auctions</a></li>
                            </ul>
                        </div>
