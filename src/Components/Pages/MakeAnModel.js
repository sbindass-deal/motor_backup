        ...
        <section className="pt_40">
            <div className="container">
                ...
                <div className="row" >
                    ...
                    <div style={{position:"absolute", right:"8%", cursor:"pointer"}}>
        ...
        <section className="pt_40" >
            <div className="container" >
                <div className="row" >
                    ...
                    <span  onClick={()=>slide2.current.slickNext()} style={{marginLeft:50}}>
                        <span>Next</span>
                        <span style={{height:"100px"}}><EastIcon/></span>
                    </span>
                    </div>
                    ...
                    <div className="col-12" style={{height:"290px"}}>
                        <div className="makes_Slide arrowTop_Slide">
                            ...
                            <div>
                                <div className="card_post" style={{ position:"absolute",right:'-12%',top:"0%" }}>
                                    <div className="card_postImg">
                                    <a href='detail'>
                                        <button type="button" className="watchedIc" data-toggle="modal" data-target="#loginModal"><span data-toggle="tooltip" data-placement="bottom" title="Notify me when one is listed"><i className="fa-solid fa-bell"></i></span></button>
                                        <img src={car_04} alt="car_04"/>
        ...
        <section className="pt_40">
            <div className="container">
                <div className="row">
                    ...
                    <span  onClick={()=>slide3.current.slickNext()} style={{marginLeft:50}}>
                        <span>Next</span>
                        <span style={{height:"100px"}}><EastIcon/></span>
                    </span>
                    </div>
