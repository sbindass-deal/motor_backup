              ...
              <tbody>
                <tr>
                  ...
                  <td className='actionBtn'>
                    <button data-toggle="modal" data-target="#MerchandiseEdit"><i class="fa-solid fa-pencil"></i></button>
                        ...
                        <div className="modal-content">
                            ...
                            <form>
                                ...
                                <div className='col-md-12 mb-3'>
                                    <small>(Accepted file types: jpg, jpeg, png, Max. file size: 10 MB, Max. files: 200.)</small></div>
                                </div>
                                <div className="form-group">
