            ...
            <div className="col-12 col-md-12 col-lg-12">
              ...
              <div className="post-excerpt">
                ...
                {/* <p>Intellectual and Other Proprietary Rights</p>
                    ...
                    <li>Your continued use of the Digital Services will be deemed as irrevocable acceptance of any revisions.</li>
                    </ul>
                    <p>Governing Law and Severability</p>
                    <ul>
                    <li>The Terms of Use shall be governed by and construed solely and exclusively in accordance with the laws of the State of New York, USA without giving effect to any law that would result in the application of the law of another jurisdiction.</li>
