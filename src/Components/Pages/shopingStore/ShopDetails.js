        ...
        <div className="row">
          ...
          <div className="col-md-6 rightSec">
            ...
            <p className="product_dec">
              <b>Product ID: T77/4733B</b>
              <br />
              Spread festive cheer with this playful pure cotton top. Comfy
              regular fit. Features a whimsical print of three penguins
              decorating a Christmas tree, plus the slogan 'Shine bright.' A
              touch of glitter adds an extra bit of magic. We only ever use
              responsibly sourced cotton for our clothe
            </p>
