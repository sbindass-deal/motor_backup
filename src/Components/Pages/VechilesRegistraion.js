                      ...
                      <div className="col-12 col-sm-12 col-md-12">
                        ...
                        <div className="form-group form-check">
                          <label className="form-check-label">
                            ...
                            below the reserve, shibnobi may choose (at its sole
                            discretion) to make up the difference. In this case
                            the vehicle will appear as sold at the below-reserve
                            price and shibnobi will pay me the difference
                            between the high bid and the reserve once the
