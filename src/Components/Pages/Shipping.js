                    ...
                    <div className="col-12 col-md-8 col-lg-8">
                        <div className="row">
                            <div className="col-12 col-md-7 ptb_40">
                                ...
                                <p>Every aspect of Bring a Trailer Shipping is managed through our simple My Shipments page. Whether you’re buying on Gas guzzlers Auctions or shipping a private vehicle, everything—including tracking and payment—is in one place.</p>
                                <br/>
