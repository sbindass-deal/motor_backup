        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card_post">
                <a href="shop/2" class="card_postImg card_postImg_200">
                  <img src={img_01} />
                </a>
                <div class="card_postInfo pt-3">
                  <h6>
                    <a href="#">Womens Gas Guzzlrs T Shirt</a>
                  </h6>
            ...
            <div class="col-12 col-md-6 col-lg-4">
              <div class="card_post">
                ...
                <div class="card_postInfo pt-3">
                  <h6>
                    <a href="#">Gas Guzzlrs Binary Shirt</a>
                  </h6>
                  <ul class="priceDateList">
