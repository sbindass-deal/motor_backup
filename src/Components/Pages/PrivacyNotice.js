...
function PrivacyPolicy() {
  return (
        ...
        <section className="ptb_80 pt_sm_50">
            <div className="container">
                <div className="row">
                    ...
                    {/* <p>Terms of Use</p> */}
                    <p>This Privacy Policy describes how store.shibnobi.com (the “Site” or “we”) collects, uses, and discloses your Personal Information when you visit or make a purchase from the Site.</p>
                    ...
                    <h2>Contact</h2>
                    <p>After reviewing this policy, if you have additional questions, want more information about our privacy practices, or would like to make a complaint, please contact us by e-mail at merch@shibnobi.com or by mail using the details provided below:</p>
                    <p></p>
                    <p>Shibnobi Inc, PO Box 0126, Walkersville MD 21793, United States</p>
    ...
    <h2>Collecting Personal Information</h2>
                    ...
                    <p></p>
                    <li><strong>Source of collection:</strong> Collected automatically when you access our Site using cookies, log files, web beacons, tags, or pixels [ADD OR SUBTRACT ANY OTHER TRACKING TECHNOLOGIES USED].</li>
                    <p></p>

                    <li><strong>Disclosure for a business purpose:</strong> shared with our processor Shopify [ADD ANY OTHER VENDORS WITH WHOM YOU SHARE THIS INFORMATION]</li>

                    <p></p>
                    <li><strong>Personal Information collected:</strong> name, billing address, shipping address, payment information (including credit card numbers [INSERT ANY OTHER PAYMENT TYPES ACCEPTED]), email address, and phone number.</li>
                    <p></p>
                    </ul>
                    ...
                    <p></p>
                    <li><strong>YSource of collection:</strong></li>
                    <p></p>
...
<li>
<strong>Personal Information collected: </strong>[INSERT ANY OTHER INFORMATION YOU COLLECT: OFFLINE DATA, PURCHASED MARKETING DATA/LISTS]
</li>
<p></p>
...
<p></p>
<li>
<strong>Disclosure for a business purpose:</strong> [ADD ANY VENDORS USED TO PROVIDE CUSTOMER SUPPORT]
</li>
<p></p>
<li><strong>Personal Information collected:</strong> [ADD ANY MODIFICATIONS TO THE INFORMATION LISTED ABOVE OR ADDITIONAL INFORMATION AS NEED.]
</li>
                    </ul>

                    <h2>Minors</h2>
                    <ul>
                    <li>The Site is not intended for individuals under the age of [INSERT AGE]. We do not intentionally collect Personal Information from children. If you are the parent or guardian and believe your child has provided us with Personal Information, please contact us at the address above to request deletion.</li>
{/*                     
                    ...
                    <ul>
                    <li>We share your Personal Information with service providers to help us provide our services and fulfill our contracts with you, as described above. For example:</li>
                    <p></p>
                    ...
                    <li>For more information about how targeted advertising works, you can visit the Network Advertising Initiative’s (“NAI”) educational page at https://www.networkadvertising.org/understanding-online-advertising/how-does-it-work.</li>
                    <p></p>
                    <li>You can opt out of targeted advertising by:

</li>
<p></p>
<li>[INCLUDE OPT-OUT LINKS FROM WHICHEVER SERVICES BEING USED. COMMON LINKS INCLUDE:</li>
<p></p>
...
<p></p>
<li>Additionally, you can opt out of some of these services by visiting the Digital Advertising Alliance’s opt-out portal at: https://optout.aboutads.info/.</li>
                    </ul>
                    <h2>Using Personal Information</h2>
                    <ul>
                    <li>We use your personal Information to provide our services to you, which includes: offering products for sale, processing payments, shipping and fulfillment of your order, and keeping you up to date on new products, services, and offers.</li>
                    <p></p>
                    <li>[INCLUDE THE FOLLOWING SECTION IF YOUR STORE IS LOCATED IN OR IF YOU HAVE CUSTOMERS IN EUROPE]</li>
                    </ul>
                    <h2>Lawful basis</h2>
                    <ul>
                    <li>Pursuant to the General Data Protection Regulation (“GDPR”), if you are a resident of the European Economic Area (“EEA”), we process your personal information under the following lawful bases:</li>
                    <p></p>
                    <li>[INCLUDE ALL THAT APPLY TO YOUR BUSINESS]</li>
                    <p></p>
                    <li>Your consent;</li>
                    <p></p>
                 ...
                 <p></p>
                    ...
                    <h2>Retention</h2>
                    <ul>
                    <li>When you place an order through the Site, we will retain your Personal Information for our records unless and until you ask us to erase this information. For more information on your right of erasure, please see the ‘Your rights’ section below.</li>
                    <p></p>
                    ...
                    <ul>
                    <li>If you are a resident of the EEA, you have the right to object to processing based solely on automated decision-making (which includes profiling), when that decision-making has a legal effect on you or otherwise significantly affects you.</li>
                    <p></p>
                    <li>We [DO/DO NOT] engage in fully automated decision-making that has a legal or otherwise significant effect using customer data.</li>
                    <p></p>
                    <li>Our processor Shopify uses limited automated decision-making to prevent fraud that does not have a legal or otherwise significant effect on you.</li>
                    <p></p>
                   <li> Services that include elements of automated decision-making include:</li>
                   <p></p>
...
<p></p>
                    ...
                    <ul>
                      <li>[INCLUDE THIS SECTION IF YOUR BUSINESS IS SUBJECT TO THE CALIFORNIA CONSUMER PRIVACY ACT AND SELLS PERSONAL INFORMATION AS DEFINED BY THE CALIFORNIA CONSUMER PRIVACY ACT]</li>
                      <p></p>
                      <li>Our Site sells Personal Information, as defined by the California Consumer Privacy Act of 2018 (“CCPA”).
...
<h2>Your rights</h2>
<ul>
  <li>[INCLUDE FOLLOWING SECTION IF YOUR STORE IS LOCATED IN OR IF YOU HAVE CUSTOMERS IN EUROPE]</li>
  <p></p>
</ul>

<h2>GDPR</h2>
<ul>
  <li>If you are a resident of the EEA, you have the right to access the Personal Information we hold about you, to port it to a new service, and to ask that your Personal Information be corrected, updated, or erased. If you would like to exercise these rights, please contact us through the contact information above. [OR INSERT ALTERNATIVE INSTRUCTIONS FOR SENDING ACCESS, ERASURE, CORRECTION, AND PORTABILITY REQUESTS]</li>
  <p></p>


  <li>Your Personal Information will be initially processed in Ireland and then will be transferred outside of Europe for storage and further processing, including to Canada and the United States. For more information on how data transfers comply with the GDPR, see Shopify’s GDPR Whitepaper: https://help.shopify.com/en/manual/your-account/privacy/GDPR.</li>
  <p></p>
  <li>[INCLUDE FOLLOWING SECTION IF YOUR BUSINESS IS SUBJECT TO THE CALIFORNIA CONSUMER PRIVACY ACT]
...
<h2>CCPA</h2>
<ul>
  <li>If you are a resident of California, you have the right to access the Personal Information we hold about you (also known as the ‘Right to Know’), to port it to a new service, and to ask that your Personal Information be corrected, updated, or erased. If you would like to exercise these rights, please contact us through the contact information above. [OR INSERT ALTERNATIVE INSTRUCTIONS FOR SENDING ACCESS, ERASURE, CORRECTION, AND PORTABILITY REQUESTS]

</li>
<p></p>

<li>If you would like to designate an authorized agent to submit these requests on your behalf, please contact us at the address above.</li>
<p></p>
</ul>

<h2>Cookies</h2>
<ul>
  <li>A cookie is a small amount of information that’s downloaded to your computer or device when you visit our Site. We use a number of different cookies, including functional, performance, advertising, and social media or content cookies. Cookies make your browsing experience better by allowing the website to remember your actions and preferences (such as login and region selection). This means you don’t have to re-enter this information each time you return to the site or browse from one page to another. Cookies also provide information on how people use the website, for instance whether it’s their first time visiting or if they are a frequent visitor.</li>
<p></p>

<li>We use the following cookies to optimize your experience on our Site and to provide our services.</li>
<p></p>
<li>[Be sure to check this list against Shopify’s current list of cookies on the merchant storefront: https://www.shopify.com/legal/cookies ]</li>
<p></p>
</ul>
...
<ul>
  <li><p><i>[INSERT OTHER COOKIES OR TRACKING TECHNOLOGIES THAT YOU USE]</i></p></li>
...
{/*                     
                    ...
                    <p>The Digital Services and Content are for general information, discussion and entertainment purposes only. The term “Content” includes, without limitation, information, data, text, photographs, videos, audio clips, written posts, articles, comments, software, scripts, graphics and interactive features generated, provided, or otherwise made available through or in connection with the Digital Services. We make no representations or guarantees about any aspect of the Digital Services and Content and do not endorse any opinions expressed by any Users. THE DIGITAL SERVICES AND ALL CONTENT ARE PUBLISHED “AS IS” AND YOUR USE OR RELIANCE ON THE DIGITAL SERVICES OR ANY CONTENT IS AT YOUR OWN RISK. WE HAVE NO LIABILITY TO YOU FOR THE CONSEQUENCES OF USING OR RELYING ON THE DIGITAL SERVICES OR ANY CONTENT.</p>
                    <p>2. Our Role</p>
                    <p>The Digital Services include a platform for vehicle listings and information services. We are not the creator or owner of the items posted on the Digital Services by Sellers for Buyers to bid on. Rather, we provide the Digital Services, which enable Users to access certain features and functionalities, including posting vehicles and other products and services, and bidding on such products and services. Sellers are responsible for ensuring that any of their User Content meets all applicable local, state, provincial, national and other laws, rules and regulations, and that any goods (including vehicles) and services promoted, offered or otherwise described on the Digital Services are described in listings, and/or delivered as described, in an accurate satisfactory manner. For any payment processing related to Purchases made on the Digital Services, if the Seller or third party responsible for the applicable vehicle or other good or service selects a payment processing method that uses a third party to process the payment, then we do not process that payment transaction.</p>
                    <p>As part of the Digital Services, shibnobiMedia may assist Sellers in the creation of their listings (including the content of such listing) but it remains each Seller’s responsibility to make sure that its listings are accurate.</p>
                    <p>shibnobiMEDIA IS NOT AN AUTOMOBILE BROKER, DEALER OR TRADITIONAL AUCTIONEER AND WE DO NOT SELL, EXCHANGE, BUY, OR OFFER FOR SALE, NEGOTIATE OR ATTEMPT TO NEGOTIATE, A SALE OR EXCHANGE OF AN INTEREST IN ANY VEHICLE LISTED ON THE DIGITAL SERVICES. shibnobiMEDIA HAS NOT EVERNEVER: (I) HELD TITLE FOR ANY VEHICLE LISTED ON THE DIGITAL SERVICES, (2) INSPECTED ANY VEHICLE LISTED ON THE DIGITAL SERVICES OR (3) HAD ANY VEHICLES LISTED ON THE DIGITAL SERVICES IN ITS LEGAL POSSESSION.</p>
                    <p>3. Privacy Notice</p>
                    <p>In connection with your access to or use of the Digital Services, we may obtain information from you directly or about you through the Digital Services. We will use your information in accordance with our <a href="https://bringatrailer.com/privacy-notice/" target="_blank" rel="noopener noreferrer">Privacy Notice</a>, which describes our privacy practices as well as choices you may have with respect to the collection and processing of some of your information. Please take a moment to review our Privacy Notice. The Privacy Notice is incorporated into this Agreement and forms part of the Agreement.</p>
                    <p>4. Accuracy of Your Information &amp; Communication Methods</p>
                    <p>The information you submit to us through the Digital Services, including as part of your account creation, registration or membership, or for any listings, must be truthful, accurate and current. You are responsible for maintaining the accuracy of such information. If we believe that your information is not truthful, accurate or current, we have the right to terminate, suspend or refuse you access to the Digital Services.</p>
                    <p>We may send you information relating to your use of the Digital Services (e.g., payment authorizations, invoices, changes in password or payment method, confirmation messages, notices) in electronic form only, for example via emails to your email address provided during registration, if applicable. You agree that any notices, agreements, disclosures or other communications that we send to you electronically will satisfy any legal communication requirements, including that such communications be in writing.</p>
                    <p>5. Age Eligibility and Legal Capacity</p>
                    <p>The Digital Services are not intended for access or use by children, especially those under the age of 13. If you are under the age of 13, you may not access or use the Digital Services or provide information to us.</p>
                    <p>By accessing or using the Digital Services, you represent that you have legal capacity to enter into this Agreement and to fulfill your obligations set out in this Agreement. If you are not of an age old enough to enter into contracts in your state (i.e., a minor), you need to review this Agreement with your parent or guardian before using the Digital Services; if your parent or guardian does not agree with the Agreement as applied to you, then you are not authorized to access or use the Digital Services.</p>
                    <p>6. Your Account; Username, Password and Other Credentials</p>
